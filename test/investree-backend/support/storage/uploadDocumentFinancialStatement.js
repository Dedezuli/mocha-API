...
describe('Storage Document Upload Financial Statement', () => {
  const beBaseUrl = req.getBackendUrl();
  const url = '/support/storage';
  const DOCUMENT_TYPE = 10;
  const DOCUMENT_TYPE_TEXT = 'Financial Statement';
  ...
  describe('#smoke', () => {
    it('Storage upload document Financial Statement should contain OSS URI #TC-1071', async function () {
      let body = {
    ...
    it('Storage upload document Financial Statement should not save file if same existing file exists #TC-1072', async function () {
    ...
    it('Storage upload document Financial Statement should be saved as dsl_document_type 10 #TC-1073', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 10, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document Financial Statement using backoffice user should succeed #TC-1074', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement JPG should have valid checksum #TC-1075', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement JPEG should have valid checksum #TC-1076', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement PNG should have valid checksum #TC-1077', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement PDF should have valid checksum #TC-1078', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document Financial Statement using BMP format #TC-1079', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document Financial Statement using sh file #TC-1080', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
