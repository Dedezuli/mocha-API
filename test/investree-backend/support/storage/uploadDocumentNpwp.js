...
describe('Storage Document Upload NPWP', () => {
  const beBaseUrl = req.getBackendUrl();
  const url = '/support/storage';
  const DOCUMENT_TYPE = 4;
  const DOCUMENT_TYPE_TEXT = 'NPWP';
  ...
  describe('#smoke', () => {
    it('Storage upload document NPWP should contain OSS URI #TC-1101', async function () {
      let body = {
    ...
    it('Storage upload document NPWP should not save file if same existing file exists #TC-1102', async function () {
    ...
    it('Storage upload document NPWP should be saved as dsl_document_type 4 #TC-1103', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 4, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document NPWP using backoffice user should succeed #TC-1104', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP JPG should have valid checksum #TC-1105', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP JPEG should have valid checksum #TC-1106', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP PNG should have valid checksum #TC-1107', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP PDF should have valid checksum #TC-1108', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document NPWP using BMP format #TC-1109', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document NPWP using sh file #TC-1110', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
