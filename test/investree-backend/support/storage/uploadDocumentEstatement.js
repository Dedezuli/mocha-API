...
describe('Storage Document Upload e-statement', () => {
  const beBaseUrl = req.getBackendUrl();
  const url = '/support/storage';
  const DOCUMENT_TYPE = 30;
  const DOCUMENT_TYPE_TEXT = 'e-statement';
  ...
  describe('#smoke', () => {
    it('Storage upload document e-statement should contain OSS URI #TC-1061', async function () {
      let body = {
    ...
    it('Storage upload document e-statement should not save file if same existing file exists #TC-1062', async function () {
    ...
    it('Storage upload document e-statement should be saved as dsl_document_type 30 #TC-1063', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 30, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document e-statement using backoffice user should succeed #TC-1064', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement JPG should have valid checksum #TC-1065', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement JPEG should have valid checksum #TC-1066', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement PNG should have valid checksum #TC-1067', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement PDF should have valid checksum #TC-1068', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document e-statement using BMP format #TC-1069', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document e-statement using sh file #TC-1070', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
