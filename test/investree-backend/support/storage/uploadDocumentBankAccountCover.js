...
describe('Storage Document Upload Bank Account Cover', () => {
  const beBaseUrl = req.getBackendUrl();
  const url = '/support/storage';
  const DOCUMENT_TYPE = 29;
  const DOCUMENT_TYPE_TEXT = 'Bank Account Cover';
  ...
  describe('#smoke', () => {
    it('Storage upload document Bank Account Cover should contain OSS URI #TC-1051', async function () {
      let body = {
    ...
    it('Storage upload document Bank Account Cover should not save file if same existing file exists #TC-1052', async function () {
    ...
    it('Storage upload document Bank Account Cover should be saved as dsl_document_type 29 #TC-1053', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 29, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document Bank Account Cover using backoffice user should succeed #TC-1054', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover JPG should have valid checksum #TC-1055', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover JPEG should have valid checksum #TC-1056', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover PNG should have valid checksum #TC-1057', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover PDF should have valid checksum #TC-1058', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document Bank Account Cover using BMP format #TC-1059', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document Bank Account Cover using sh file #TC-1060', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
