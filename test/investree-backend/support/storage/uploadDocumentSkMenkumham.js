...
describe('Storage Document Upload SK Menkumham', () => {
  ...
  describe('#smoke', () => {
    it('Storage upload document SK Menkumham should contain OSS URI #TC-1131', async function () {
      let body = {
    ...
    it('Storage upload document SK Menkumham should not save file if same existing file exists #TC-1132', async function () {
    ...
    it('Storage upload document SK Menkumham should be saved as dsl_document_type 8 #TC-1133', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document SK Menkumham using backoffice user should succeed #TC-1134', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SK Menkumham JPG should have valid checksum #TC-1135', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SK Menkumham JPEG should have valid checksum #TC-1136', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SK Menkumham PNG should have valid checksum #TC-1137', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SK Menkumham PDF should have valid checksum #TC-1138', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document SK Menkumham using BMP format #TC-1139', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document SK Menkumham using sh file #TC-1140', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
