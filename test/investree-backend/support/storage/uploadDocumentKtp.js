...
describe('Storage Document Upload KTP', () => {
  ...
  describe('#smoke', () => {
    it('Storage upload document KTP should contain OSS URI #TC-1081', async function () {
      let body = {
    ...
    it('Storage upload document KTP should not save file if same existing file exists #TC-1082', async function () {
    ...
    it('Storage upload document KTP should be saved as dsl_document_type 1 #TC-1083', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 1, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document KTP using backoffice user should succeed #TC-1084', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP JPG should have valid checksum #TC-1085', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP JPEG should have valid checksum #TC-1086', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP PNG should have valid checksum #TC-1087', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP PDF should have valid checksum #TC-1088', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document KTP using BMP format #TC-1089', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document KTP using sh file #TC-1090', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
