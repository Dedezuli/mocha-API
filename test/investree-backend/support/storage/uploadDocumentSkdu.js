...
describe('Storage Document Upload SKDU', () => {
  const beBaseUrl = req.getBackendUrl();
  const url = '/support/storage';
  const DOCUMENT_TYPE = 28;
  const DOCUMENT_TYPE_TEXT = 'SKDU';
  ...
  describe('#smoke', () => {
    it('Storage upload document SKDU should contain OSS URI #TC-1121', async function () {
      let body = {
    ...
    it('Storage upload document SKDU should not save file if same existing file exists #TC-1122', async function () {
    ...
    it('Storage upload document SKDU should be saved as dsl_document_type 28 #TC-1123', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 28, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document SKDU using backoffice user should succeed #TC-1124', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU JPG should have valid checksum #TC-1125', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU JPEG should have valid checksum #TC-1126', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU PNG should have valid checksum #TC-1127', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU PDF should have valid checksum #TC-1128', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document SKDU using BMP format #TC-1129', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document SKDU using sh file #TC-1130', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
