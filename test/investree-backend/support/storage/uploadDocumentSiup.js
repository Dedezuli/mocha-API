...
describe('Storage Document Upload SIUP', () => {
  ...
  describe('#smoke', () => {
    it('Storage upload document SIUP should contain OSS URI #TC-1111', async function () {
      let body = {
    ...
    it('Storage upload document SIUP should not save file if same existing file exists #TC-1112', async function () {
    ...
    it('Storage upload document SIUP should be saved as dsl_document_type 5 #TC-1113', async function () {
      const knex = require('knex')(newcoreDbConfig);
      ...
      expect(row.dsl_document_type).to.eql(
        DOCUMENT_TYPE,
        `Expected dsl_document_type of 5, but got ${row.dsl_document_type}`
      );
    });

    it('Storage upload document SIUP using backoffice user should succeed #TC-1114', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP JPG should have valid checksum #TC-1115', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP JPEG should have valid checksum #TC-1116', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP PNG should have valid checksum #TC-1117', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP PDF should have valid checksum #TC-1118', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', () => {
    it('Should fail when storage upload document SIUP using BMP format #TC-1119', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document SIUP using sh file #TC-1120', async function () {
      let body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
