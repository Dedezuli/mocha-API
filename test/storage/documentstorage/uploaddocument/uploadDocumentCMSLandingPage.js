...
describe('Storage Document Upload CMS Landing Page', function () {
  ...
  describe('#smoke', function () {
    it('Should contain OSS URI #TC-1614', async function () {
      const body = {
    ...
    it('Should not save file if file already exist #TC-1615', async function () {
    ...
    it('Should be saved as dsl_document_type 56 #TC-1616', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Upload JPG should have valid checksum #TC-1618', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
    ...
    it('Upload JPEG should have valid checksum #TC-1619', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
    ...
    it('Upload PNG should have valid checksum #TC-1620', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
    ...
    it('Upload PDF should have valid checksum #TC-1621', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
  ...
  describe('#negative', function () {
    it('Should fail when upload using BMP format #TC-1622', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
    ...
    it('Should fail when upload using sh file #TC-1623', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: BO_ID,
        createdBy: BO_ID
