...
describe('Storage Document Upload SIUP', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document SIUP should contain OSS URI #TC-954', async function () {
      const body = {
    ...
    it('Storage upload document SIUP should not save file if same existing file exists #TC-955', async function () {
    ...
    it('Storage upload document SIUP should be saved as dsl_document_type 5 #TC-956', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document SIUP using backoffice user should succeed #TC-957', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP JPG should have valid checksum #TC-958', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP JPEG should have valid checksum #TC-959', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP PNG should have valid checksum #TC-960', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document SIUP PDF should have valid checksum #TC-961', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document SIUP using BMP format #TC-962', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document SIUP using sh file #TC-963', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
