...
describe('Storage Document Upload Akta Pendirian', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document Akta Pendirian should contain OSS URI #TC-874', async function () {
      const body = {
    ...
    it('Storage upload document Akta Pendirian should not save file if same existing file exists #TC-875', async function () {
    ...
    it('Storage upload document Akta Pendirian should be saved as dsl_document_type 7 #TC-876', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document Akta Pendirian using backoffice user should succeed #TC-877', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Pendirian JPG should have valid checksum #TC-878', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Pendirian JPEG should have valid checksum #TC-879', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Pendirian PNG should have valid checksum #TC-880', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Pendirian PDF should have valid checksum #TC-881', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document Akta Pendirian using BMP format #TC-882', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document Akta Pendirian using sh file #TC-883', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
