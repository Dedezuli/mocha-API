...
describe('Storage Document Upload KTP', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document KTP should contain OSS URI #TC-924', async function () {
      const body = {
    ...
    it('Storage upload document KTP should not save file if same existing file exists #TC-925', async function () {
    ...
    it('Storage upload document KTP should be saved as dsl_document_type 1 #TC-926', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document KTP using backoffice user should succeed #TC-927', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP JPG should have valid checksum #TC-928', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP JPEG should have valid checksum #TC-929', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP PNG should have valid checksum #TC-930', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document KTP PDF should have valid checksum #TC-931', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document KTP using BMP format #TC-932', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document KTP using sh file #TC-933', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
