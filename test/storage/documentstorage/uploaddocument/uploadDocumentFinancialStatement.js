...
describe('Storage Document Upload Financial Statement', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document Financial Statement should contain OSS URI #TC-914', async function () {
      const body = {
    ...
    it('Storage upload document Financial Statement should not save file if same existing file exists #TC-915', async function () {
    ...
    it('Storage upload document Financial Statement should be saved as dsl_document_type 10 #TC-916', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document Financial Statement using backoffice user should succeed #TC-917', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement JPG should have valid checksum #TC-918', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement JPEG should have valid checksum #TC-919', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement PNG should have valid checksum #TC-920', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Financial Statement PDF should have valid checksum #TC-921', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document Financial Statement using BMP format #TC-922', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document Financial Statement using sh file #TC-923', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
