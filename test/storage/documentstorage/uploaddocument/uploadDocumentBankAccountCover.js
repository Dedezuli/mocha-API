...
describe('Storage Document Upload Bank Account Cover', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document Bank Account Cover should contain OSS URI #TC-894', async function () {
      const body = {
    ...
    it('Storage upload document Bank Account Cover should not save file if same existing file exists #TC-895', async function () {
    ...
    it('Storage upload document Bank Account Cover should be saved as dsl_document_type 29 #TC-896', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document Bank Account Cover using backoffice user should succeed #TC-897', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover JPG should have valid checksum #TC-898', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover JPEG should have valid checksum #TC-899', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover PNG should have valid checksum #TC-900', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document Bank Account Cover PDF should have valid checksum #TC-901', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document Bank Account Cover using BMP format #TC-902', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document Bank Account Cover using sh file #TC-903', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
