...
describe('Storage Document Upload Akta Perubahan Terakhir', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document Akta Perubahan Terakhir should contain OSS URI #TC-884', async function () {
      const body = {
    ...
    it('Storage upload document Akta Perubahan Terakhir should not save file if same existing file exists #TC-885', async function () {
    ...
    it('Storage upload document Akta Perubahan Terakhir should be saved as dsl_document_type 9 #TC-886', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document Akta Perubahan Terakhir using backoffice user should succeed #TC-887', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Perubahan Terakhir JPG should have valid checksum #TC-888', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Perubahan Terakhir JPEG should have valid checksum #TC-889', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Perubahan Terakhir PNG should have valid checksum #TC-890', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Storage upload document Akta Perubahan Terakhir PDF should have valid checksum #TC-891', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document Akta Perubahan Terakhir using BMP format #TC-892', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
    ...
    it('Should fail when storage upload document Akta Perubahan Terakhir using sh file #TC-893', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdInstitutional,
        createdBy: customerIdInstitutional
