...
describe('Storage Document Upload NPWP', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document NPWP should contain OSS URI #TC-944', async function () {
      const body = {
    ...
    it('Storage upload document NPWP should not save file if same existing file exists #TC-945', async function () {
    ...
    it('Storage upload document NPWP should be saved as dsl_document_type 4 #TC-946', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document NPWP using backoffice user should succeed #TC-947', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP JPG should have valid checksum #TC-948', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP JPEG should have valid checksum #TC-949', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP PNG should have valid checksum #TC-950', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document NPWP PDF should have valid checksum #TC-951', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document NPWP using BMP format #TC-952', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document NPWP using sh file #TC-953', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
