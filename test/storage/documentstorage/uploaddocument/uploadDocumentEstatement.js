...
describe('Storage Document Upload e-statement', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document e-statement should contain OSS URI #TC-904', async function () {
      const body = {
    ...
    it('Storage upload document e-statement should not save file if same existing file exists #TC-905', async function () {
    ...
    it('Storage upload document e-statement should be saved as dsl_document_type 30 #TC-906', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document e-statement using backoffice user should succeed #TC-907', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement JPG should have valid checksum #TC-908', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement JPEG should have valid checksum #TC-909', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement PNG should have valid checksum #TC-910', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document e-statement PDF should have valid checksum #TC-911', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document e-statement using BMP format #TC-912', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document e-statement using sh file #TC-913', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
