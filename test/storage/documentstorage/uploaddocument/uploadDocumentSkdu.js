...
describe('Storage Document Upload SKDU', function () {
  ...
  describe('#smoke', function () {
    it('Storage upload document SKDU should contain OSS URI #TC-964', async function () {
      const body = {
    ...
    it('Storage upload document SKDU should not save file if same existing file exists #TC-965', async function () {
    ...
    it('Storage upload document SKDU should be saved as dsl_document_type 28 #TC-966', async function () {
      const knex = require('knex')(newcoreDbConfig);
    ...
    it('Storage upload document SKDU using backoffice user should succeed #TC-967', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU JPG should have valid checksum #TC-968', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU JPEG should have valid checksum #TC-969', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU PNG should have valid checksum #TC-970', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Storage upload document SKDU PDF should have valid checksum #TC-971', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
  ...
  describe('#negative', function () {
    it('Should fail when storage upload document SKDU using BMP format #TC-972', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
    ...
    it('Should fail when storage upload document SKDU using sh file #TC-973', async function () {
      const body = {
        documentType: DOCUMENT_TYPE,
        userId: customerIdIndividual,
        createdBy: customerIdIndividual
