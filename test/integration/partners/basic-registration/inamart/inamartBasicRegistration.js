...
describe('Integration Inamart Basic Registration', () => {
  const url = '/validate/integration/partners/basic-registration/inamart';
  ...
  describe('#smoke', () => {
    it('Inamart basic registration should succeed #TC-437', async function () {
