...
const url = '/partners/v1/business/registration/completing';
const legacyBaseUrl = request.getLegacyUrl();

describe('Completing Data ADW', () => {
  beforeEach(async function () {
    ...
    report.setInfo(this, `Success to regist ADW with borrower number ${borrowerNumber} and email ${email}`);
  });
  describe('#smoke', () => {
    it('Completing data with borrower type conventional should succeed #TC-1016', async function () {
      ...
      report.setIssue(this, 'BIZ-1009');

      expect(res.body.partner_name).to.eql('adw');
      expect(res.body.meta.code).to.eql(200);
    });

    it('Completing data with borrower type conventional and syariah should be success #TC-1017', async function () {
      let body = generateBodyCompletingData(borrowerNumber, email);
    ...
    it('Completing data with borrower type syariah should be success #TC-1018', async function () {
      let body = generateBodyCompletingData(borrowerNumber, email);
    ...
    it('Hit completing data twice should succeed #TC-1019', async function () {
  ...
  describe('#negative', () => {
    it('Completing data of borrowerNumber that not belong to respective email should be failed #TC-1020', async function () {
    ...
    it('Completing data with non unique npwp number should failed #TC-1021', async function () {
