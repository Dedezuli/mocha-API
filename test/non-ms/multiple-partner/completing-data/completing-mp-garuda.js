...
describe('Completing Data Multiple Partner', () => {
  ...
  describe('#smoke', () => {
    it('Garuda completing data using borrower who had already filled completing data via MbizDM should succeed #TC-1508', async function () {
      ...
      const resCompDataGaruda = await chai
      ...
      report.setPayload(this, resCompDataGaruda, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resCompDataGaruda.body.partner_name).to.eql('Garuda');
      expect(resCompDataGaruda.body.meta.code).to.eql(200);
    });
    it('Garuda completing data using borrower who had already filled completing data via ADW should succeed #TC-1509', async function () {
    ...
    it('Garuda completing data using borrower who had already filled completing data via Inamart should succeed #TC-1510', async function () {
    ...
    it('Garuda completing data using borrower who had already filled completing data via Billtree should succeed #TC-1511', async function () {
    ...
    it('Garuda completing data using borrower who has more than 1 partner should succeed #TC-1512', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
    ...
    it('Garuda completing data using borrower who has already registered via another partner with different borrower type should succeed #TC-1513', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegGaruda(email);
      let bodyCompDataGaruda = generateBodyCDGaruda(email, borrowerNumber);
      bodyCompDataGaruda.borrower_type = '2';
    ...
    it('Garuda completing data using borrower who has already registered via another partner with status inactive should succeed #TC-1514', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegGaruda(email);
  ...
  describe('#negative', () => {
    it('Garuda completing data using borrower who has already registered via another partner with status rejected should failed #TC-1515', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegGaruda(email);
      ...
      expect(resCompDataGaruda.body.partner_name).to.eql('Garuda');
      expect(resCompDataGaruda.body.meta.code).to.eql(400);
    });
    it('Garuda completing data without Garuda basic registration using MbizDM registered borrower should fail #TC-1516', async function () {
      let borrowerNumber = await basicRegMbizDM(email);
      await compDataMbizDM(email, borrowerNumber);
      let bodyCompDataGaruda = generateBodyCDGaruda(email, borrowerNumber);
    ...
    it('Garuda completing data without Garuda basic registration using ADW registered borrower should fail #TC-1517', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
      let bodyCompDataGaruda = generateBodyCDGaruda(email, borrowerNumber);
    ...
    it('Garuda completing data without Garuda basic registration using Inamart registered borrower should fail #TC-1518', async function () {
      let borrowerNumber = await basicRegInamart(email);
      await compDataInamart(email, borrowerNumber);
      let bodyCompDataGaruda = generateBodyCDGaruda(email, borrowerNumber);
    ...
    it('Garuda completing data without Garuda basic registration using Billtree registered borrower should fail #TC-1519', async function () {
      this.skip();
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      let bodyCompDataGaruda = generateBodyCDGaruda(email, borrowerNumber);
