...
describe('Completing Data Multiple Partner', () => {
  ...
  describe('#smoke', () => {
    it('MbizDM completing data using borrower who had already filled completing data via ADW should succeed #TC-1532', async function () {
      ...
      report.setPayload(this, resCompDataMbizDM, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resCompDataMbizDM.body.partner_name).to.eql('MbizDM');
      expect(resCompDataMbizDM.body.meta.code).to.eql(200);
    });
    it('MbizDM completing data using borrower who had already filled completing data via Garuda should succeed #TC-1533', async function () {
    ...
    it('MbizDM completing data using borrower who had already filled completing data via Inamart should succeed #TC-1534', async function () {
    ...
    it('MbizDM completing data using borrower who had already filled completing data via Billtree should succeed #TC-1535', async function () {
    ...
    it('MbizDM completing data using borrower who has more than 1 partner should succeed #TC-1536', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
    ...
    it('MbizDM completing data using borrower who has already registered via another partner with different borrower type should succeed #TC-1537', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);

      await basicRegMbizDM(email);
      let bodyCompDataMbizDM = generateBodyCDMbizDM(email, borrowerNumber);
      bodyCompDataMbizDM.borrower_type = '2';
    ...
    it('MbizDM completing data using borrower who has already registered via another partner with status inactive should succeed #TC-1538', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegMbizDM(email);
  ...
  describe('#negative', () => {
    it('MbizDM completing data using borrower who has already registered via another partner with status rejected should failed #TC-1539', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegMbizDM(email);
      ...
      expect(resCompDataMbizDM.body.partner_name).to.eql('MbizDM');
      expect(resCompDataMbizDM.body.meta.code).to.eql(400);
    });
    it('MbizDM completing data without MbizDM basic registration using ADW registered borrower should fail #TC-1540', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
      let bodyCompDataMbizDM = generateBodyCDMbizDM(email, borrowerNumber);
    ...
    it('MbizDM completing data without MbizDM basic registration using Garuda registered borrower should fail #TC-1541', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
      let bodyCompDataMbizDM = generateBodyCDMbizDM(email, borrowerNumber);
    ...
    it('MbizDM completing data without MbizDM basic registration using Inamart registered borrower should fail #TC-1542', async function () {
      let borrowerNumber = await basicRegInamart(email);
      await compDataInamart(email, borrowerNumber);
      let bodyCompDataMbizDM = generateBodyCDMbizDM(email, borrowerNumber);
    ...
    it('MbizDM completing data without MbizDM basic registration using Billtree registered borrower should fail #TC-1543', async function () {
      this.skip();
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      let bodyCompDataMbizDM = generateBodyCDMbizDM(email, borrowerNumber);
