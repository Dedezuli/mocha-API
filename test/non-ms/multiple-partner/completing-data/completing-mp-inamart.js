...
describe('Completing Data Multiple Partner', () => {
  beforeEach(async function () {
    email = `MPInamart.${help.randomEmail()}`;
  });
  describe('#smoke', () => {
    it('Inamart completing data using borrower who had already filled completing data via MbizDM should succeed #TC-1520', async function () {
      ...
      report.setPayload(this, resCompDataInamart, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resCompDataInamart.body.partner_name).to.eql('Inamart');
      expect(resCompDataInamart.body.meta.code).to.eql(200);
    });
    it('Inamart completing data using borrower who had already filled completing data via Garuda should succeed #TC-1521', async function () {
    ...
    it('Inamart completing data using borrower who had already filled completing data via ADW should succeed #TC-1522', async function () {
    ...
    it('Inamart completing data using borrower who had already filled completing data via Billtree should succeed #TC-1523', async function () {
    ...
    it('Inamart completing data using borrower who has more than 1 partner should succeed #TC-1524', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
    ...
    it('Inamart completing data using borrower who has already registered via another partner with different borrower type should succeed #TC-1525', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);

      await basicRegInamart(email);
      let bodyCompDataInamart = generateBodyCDInamart(email, borrowerNumber);
      bodyCompDataInamart.borrower_type = '2';
    ...
    it('Inamart completing data using borrower who has already registered via another partner with status inactive should succeed #TC-1526', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegInamart(email);
  ...
  describe('#negative', () => {
    it('Inamart completing data using borrower who has already registered via another partner with status rejected should failed #TC-1527', async function () {
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      await basicRegInamart(email);
    ...
    it('Inamart completing data without Inamart basic registration using MbizDM registered borrower should fail #TC-1528', async function () {
      let borrowerNumber = await basicRegMbizDM(email);
      await compDataMbizDM(email, borrowerNumber);
      let bodyCompDataInamart = generateBodyCDInamart(email, borrowerNumber);
      ...
      expect(resCompDataInamart.body.partner_name).to.eql('Inamart');
      expect(resCompDataInamart.body.meta.code).to.eql(400);
    });
    it('Inamart completing data without Inamart basic registration using Garuda registered borrower should fail #TC-1529', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
      let bodyCompDataInamart = generateBodyCDInamart(email, borrowerNumber);
    ...
    it('Inamart completing data without Inamart basic registration using ADW registered borrower should fail #TC-1530', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
      let bodyCompDataInamart = generateBodyCDInamart(email, borrowerNumber);
    ...
    it('Inamart completing data without Inamart basic registration using Billtree registered borrower should fail #TC-1531', async function () {
      this.skip();
      let borrowerNumber = await basicRegBilltree(email);
      await compDataBilltree(email, borrowerNumber);
      let bodyCompDataInamart = generateBodyCDInamart(email, borrowerNumber);
