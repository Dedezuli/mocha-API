...
describe('Basic Registration Multiple Partner', () => {
  ...
  describe('#smoke', () => {
    it('Billtree basic registration using borrower who had already filled completing data via MbizDM should succeed #TC-1229', async function () {
      ...
      report.setPayload(this, resRegistBilltree, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resRegistBilltree.body.partner_name).to.eql('Billtree');
      expect(resRegistBilltree.body.meta.code).to.eql(200);
    });
    it('Billtree basic registration using borrower who had already filled completing data via Garuda should succeed #TC-1230', async function () {
    ...
    it('Billtree basic registration using borrower who had already filled completing data via Inamart should succeed #TC-1231', async function () {
    ...
    it('Billtree basic registration using borrower who had already filled completing data via ADW should succeed #TC-1232', async function () {
    ...
    it('Billtree basic registration using borrower who has more than 1 partner should succeed #TC-1233', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
    ...
    it('Billtree basic registration using same phone number as borrower registered via another partner should succeed #TC-1234', async function () {
      ...
      let bodyRegistBilltree = generateBodyBilltree(email);
      bodyRegistBilltree.personal_info.phone_number = phoneNumber;
    ...
    it('Billtree basic registration using borrower who has already registered via another partner with status inactive should succeed #TC-1230', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
  ...
  describe('#negative', () => {
    it('Billtree basic registration using MbizDM borrower that is still in basic registration should fail #TC-1235', async function () {
      this.skip();
      await basicRegMbizDM(email);
      let bodyRegistBilltree = generateBodyBilltree(email);
      ...
      expect(resRegistBilltree.body.partner_name).to.eql('Billtree');
      expect(resRegistBilltree.body.meta.code).to.eql(400);
    });
    it('Billtree basic registration using Garuda borrower that is still in basic registration should fail #TC-1236', async function () {
      this.skip();
    ...
    it('Billtree basic registration using Inamart borrower that is still in basic registration should fail #TC-1237', async function () {
      this.skip();
    ...
    it('Billtree basic registration using ADW borrower that is still in basic registration should fail #TC-1238', async function () {
      this.skip();
    ...
    it('Billtree basic registration using borrower who has already registered via another partner with status rejected should failed #TC-1230', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
