...
describe('Basic Registration Multiple Partner', () => {
  beforeEach(async function () {
    email = `MPGaruda.${help.randomEmail()}`;
  });

  describe('#smoke', () => {
    it('Garuda basic registration using borrower who had already filled completing data via MbizDM should succeed #TC-1253', async function () {
      let borrowerNumber = await basicRegMbizDM(email);
      await compDataMbizDM(email, borrowerNumber);

      let bodyRegistGaruda = generateBodyOtherPartner(email, 'Garuda');
      ...
      report.setPayload(this, resRegistGaruda, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resRegistGaruda.body.partner_name).to.eql('Garuda');
      expect(resRegistGaruda.body.meta.code).to.eql(200);
    });
    it('Garuda basic registration using borrower who had already filled completing data via ADW should succeed #TC-1254', async function () {
    ...
    it('Garuda basic registration using borrower who had already filled completing data via Inamart should succeed #TC-1255', async function () {
    ...
    it('Garuda basic registration using borrower who had already filled completing data via Billtree should succeed #TC-1256', async function () {
    ...
    it('Garuda basic registration using borrower who has more than 1 partner should succeed #TC-1257', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
    ...
    it('Garuda basic registration using same phone number as borrower registered via another partner should succeed #TC-1258', async function () {
      let bodyRegistAdw = generateBodyOtherPartner(email);
      let phoneNumber = bodyRegistAdw.personal_info.phone_number;
      ...
      let bodyRegistGaruda = generateBodyOtherPartner(email, 'Garuda');
      bodyRegistAdw.personal_info.phone_number = phoneNumber;
    ...
    it('Garuda basic registration using borrower who has already registered via another partner with status inactive should succeed #TC-1259', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
  ...
  describe('#negative', () => {
    it('Garuda basic registration using MbizDM borrower that is still in basic registration should fail #TC-1260', async function () {
      ...
      expect(resRegistGaruda.body.partner_name).to.eql('Garuda');
      expect(resRegistGaruda.body.meta.code).to.eql(400);
    });
    it('Garuda basic registration using ADW borrower that is still in basic registration should fail #TC-1261', async function () {
    ...
    it('Garuda basic registration using Inamart borrower that is still in basic registration should fail #TC-1262', async function () {
    ...
    it('Garuda basic registration using Billtree borrower that is still in basic registration should fail #TC-1263', async function () {
      await basicRegBilltree(email);
      let bodyRegistGaruda = generateBodyOtherPartner(email, 'Garuda');
    ...
    it('Garuda basic registration using borrower who has already registered via another partner with status rejected should succeed #TC-1264', async function () {
      let borrowerNumber = await basicRegAdw(email);
      await compDataAdw(email, borrowerNumber);
