...
describe('Basic Registration Multiple Partner', () => {
  ...
  describe('#smoke', () => {
    it('ADW basic registration using borrower who had already filled completing data via MbizDM should succeed #TC-1229', async function () {
      let borrowerNumber = await basicRegMbizDM(email);
      await compDataMbizDM(email, borrowerNumber);
      let bodyRegistAdw = generateBodyOtherPartner(email, 'ADW');
      ...
      report.setPayload(this, resRegistAdw, responseTime);
      report.setSeverity(this, 'blocker');
      report.setIssue(this, 'BIZ-870');

      expect(resRegistAdw.body.partner_name).to.eql('adw');
      expect(resRegistAdw.body.meta.code).to.eql(200);
    });
    it('ADW basic registration using borrower who had already filled completing data via Garuda should succeed #TC-1230', async function () {
    ...
    it('ADW basic registration using borrower who had already filled completing data via Inamart should succeed #TC-1231', async function () {
    ...
    it('ADW basic registration using borrower who had already filled completing data via Billtree should succeed #TC-1232', async function () {
    ...
    it('ADW basic registration using borrower who has more than 1 partner should succeed #TC-1233', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
    ...
    it('ADW basic registration using same phone number as borrower registered via another partner should succeed #TC-1234', async function () {
    ...
    it('ADW basic registration using borrower who has already registered via another partner with status inactive should succeed #TC-1239', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
  ...
  describe('#negative', () => {
    it('ADW basic registration using MbizDM borrower that is still in basic registration should fail #TC-1235', async function () {
      ...
      expect(resRegistAdw.body.partner_name).to.eql('adw');
      expect(resRegistAdw.body.meta.code).to.eql(400);
    });
    it('ADW basic registration using Garuda borrower that is still in basic registration should fail #TC-1236', async function () {
    ...
    it('ADW basic registration using Inamart borrower that is still in basic registration should fail #TC-1237', async function () {
    ...
    it('ADW basic registration using Billtree borrower that is still in basic registration should fail #TC-1238', async function () {
      await basicRegBilltree(email);
      let bodyRegistAdw = generateBodyOtherPartner(email, 'ADW');
    ...
    it('ADW basic registration using borrower who has already registered via another partner with status rejected should succeed #TC-1240', async function () {
      let borrowerNumber = await basicRegGaruda(email);
      await compDataGaruda(email, borrowerNumber);
