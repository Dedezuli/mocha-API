...
describe('survey information for individual borrower', function () {
  ...
  describe('#smoke', function () {
    ...
    it('when adding new survey information, the data should be syncronize between legacy and newcore #TC-440', async function () {
    ...
    it('when editing survey information, the data should be syncronize between legacy and newcore #TC-441', async function () {
      report.setInfo(this, 'add new survey');
      const body = generateBody(customerId);
      const res = await chai
        .request(svcBaseUrl)
    ...
    it('legacy data should be update with the new survey, when new survey has latest survey date than current survey #TC-442', async function () {
      report.setInfo(this, 'add new survey');
      const body = generateBody(customerId);
      const res = await chai
        .request(svcBaseUrl)
    ...
    it("legacy data shouldn't be update with the new survey, when new survey has older survey date than current survey #TC-443", async function () {
      report.setInfo(this, 'add new survey');
      const body = generateBody(customerId);
      const res = await chai
        .request(svcBaseUrl)
    ...
    it('legacy data should update survey with the latest updated, if two survey has same survey date #TC-444', async function () {
    ...
    it('legacy data should update survey with the newer survey id, if two survey has same survey date, and same update at  #TC-445', async function () {
    ...
    it('when deleting a survey the second lateast survey should be updated to legacy survey data #TC-446', async function () {
      report.setInfo(this, 'add new survey');
    ...
    it('when deleting all of the survey, the survey data in both of legacy and newcore survey data should be replace with empty string #TC-447', async function () {
      report.setInfo(this, 'add new survey');
      const body = generateBody(customerId);
      const res = await chai
        .request(svcBaseUrl)
  ...
  describe('#negative', function () {
    ...
    it('adding survey information should fail when the data failed to sync with legacy #TC-448', async function () {
      const dataNC = await chai
        .request(svcBaseUrl)
        .get(getNewcoreUrl)
        .set(
    ...
    it('editing survey information should fail when the data failed to sync withlegacy #TC-449', async function () {
    ...
    it('delete survey information should fail when the data failed to sync withlegacy #TC-450', async function () {
      const body = generateBody(
        customerId,
        true,
